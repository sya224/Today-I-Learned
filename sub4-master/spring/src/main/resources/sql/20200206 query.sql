...
ALTER TABLE `sns` ADD CONSTRAINT `FK_mem_info_TO_sns_1` FOREIGN KEY (
	`mem_id`
)
REFERENCES `mem_info` (
	`mem_id`
...
ALTER TABLE `confirm_email` ADD CONSTRAINT `FK_mem_info_TO_confirm_email_1` FOREIGN KEY (
	`mem_id`
)
REFERENCES `mem_info` (
	`mem_id`
